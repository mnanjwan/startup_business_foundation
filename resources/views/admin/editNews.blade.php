                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <button style="float: right" class="m-0 font-weight-bold text-primary"> <a
                                            href="{{ route('all-news.admin') }}">Back</a> </button>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('process-edit-post-news.admin', ['id' => $post->id]) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                id="exampleFormControlInput1" value="{{ $post->title }}" placeholder="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" value="{{ $post->image }}"
                                                name="image">
                                            <span class="col-sm-9 text-danger">
                                                @error('image')
                                                    {{ $message }}
