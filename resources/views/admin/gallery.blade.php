                        ...
                        <div class="row">
                          <div class="col">
                            <div class="alert alert-success" role="alert">
                                ...
                                <p style="font-size: 2em"><b>No of Images: {{$countimage}}</b></p>
                                <hr>
                          ...
                          <div class="col">
                            <div class="alert alert-danger" role="alert">
                                ...
                                <p style="font-size: 2em"><b>No of Video: {{$countvideo}}</b></p>
                                <hr>
                                {{-- <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p> --}}
                              </div>
                          </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <a style="float: right" class="btn btn-primary" href="{{ route('admin.gallery-all-images') }}"
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.gallery-image') }}" method="post"
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <a style="float: right" class="btn btn-primary" href="{{ route('admin.gallery-all-video') }}"
                                role="button">All Video</a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.gallery-video') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Video Caption</label>
                                        <input type="text" class="form-control" name="caption"
                                            id="exampleFormControlInput1" placeholder="" required>
                                        <span class="col-sm-9 text-danger">
                                            @error('caption')
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Vidoe Url</label>
